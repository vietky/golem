...
const UpgradeModal = ({ card, playerResources, onConfirm, onCancel, maxTurnUpgrade }) => {
  ...
  const crystalTypes = [
    { key: "yellow", label: "Yellow", level: 1, image: "/images/stone_yellow.JPG" },
    { key: "green", label: "Green", level: 2, image: "/images/stone_green.JPG" },
    { key: "blue", label: "Blue", level: 3, image: "/images/stone_blue.JPG" },
    { key: "pink", label: "Pink", level: 4, image: "/images/stone_pink.JPG" },
  ];
